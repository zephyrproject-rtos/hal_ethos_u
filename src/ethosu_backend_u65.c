...
static bool u65_dev_init(struct ethosu_device *dev,
                         ...
                         uint32_t privilege_enable)
{
    ...
    {
        LOG_ERR("Failed to initialize Ethos-U65 device. Wrong device type (got %d, expected %d",
    ...
    dev->caps.product   = ETHOSU_PRODUCT_U65;
...
static void u65_dev_axi_init(struct ethosu_device *dev)
{
    struct u65_config_t *cfg = (struct u65_config_t *)dev->config->config;
...
static void u65_dev_run_command_stream(struct ethosu_device *dev,
...
static void u65_dev_print_err_status(struct ethosu_device *dev)
{
...
static bool u65_dev_handle_interrupt(struct ethosu_device *dev)
{
    struct cmd_r cmd;
...
static bool u65_dev_verify_access_state(struct ethosu_device *dev)
{
...
static bool u65_dev_soft_reset(struct ethosu_device *dev)
{
...
static void u65_dev_get_hw_info(struct ethosu_device *dev, struct ethosu_hw_info *hwinfo)
{
    struct config_r cfg;
    struct id_r id;
...
static void u65_dev_set_clock_and_power(struct ethosu_device *dev,
...
static bool u65_dev_verify_optimizer_config(struct ethosu_device *dev, uint32_t cfg_in, uint32_t id_in)
{
...
static const struct ethosu_device_ops u65_ops = {
    .init                    = u65_dev_init,
    .axi_init                = u65_dev_axi_init,
    .run_command_stream      = u65_dev_run_command_stream,
    .print_err_status        = u65_dev_print_err_status,
    .handle_interrupt        = u65_dev_handle_interrupt,
    .get_hw_info             = u65_dev_get_hw_info,
    .verify_access_state     = u65_dev_verify_access_state,
    .soft_reset              = u65_dev_soft_reset,
    .set_clock_and_power     = u65_dev_set_clock_and_power,
    .verify_optimizer_config = u65_dev_verify_optimizer_config,
};

const struct ethosu_device_desc ethosu_device_desc_u65 = {
    .name = "ethos-u65",
    .ops  = &u65_ops,
};
...
struct u65_config_t u65_config_default = {
...
struct ethosu_device_config ethosu_device_config_u65 = {
    .config = &u65_config_default,
};
